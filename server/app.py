...
class Restaurants(Resource):
    def get(self):
        ...
        my_restaurant_list = [{"id": restaurant.id, "name": restaurant.name, "address": restaurant.address} for restaurant in restaurants]
        response = make_response(jsonify(my_restaurant_list), 200)
        return response
...
class Pizzas(Resource):
    def get(self):
        ...
        my_pizza_list = [{"id": pizza.id, "name": pizza.name, "ingredients": pizza.ingredients} for pizza in my_pizzas]
        response = make_response(jsonify(my_pizza_list), 200)
        return response
